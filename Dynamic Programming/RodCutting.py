...
class RodCutting:
    ...
    def dynamicProgrammingTabulationSpace(self, prices: List[int], length: int) -> int:
...
if __name__ == '__main__':
    ...
    print(rodCutting.dynamicProgrammingTabulationSpace([3, 5, 6, 7, 10, 12], 6))
